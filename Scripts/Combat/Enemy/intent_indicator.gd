...
var intent_sprite_dictionary = {
	...
	EnemyAttack.EnemyAttackType.REPLACE_RED : "res://Art/Puyo_Red.png",
	EnemyAttack.EnemyAttackType.REPLACE_BLUE : "res://Art/Puyo_Blue.png",
	EnemyAttack.EnemyAttackType.REPLACE_GREEN : "res://Art/Puyo_Green.png",
	EnemyAttack.EnemyAttackType.REPLACE_YELLOW : "res://Art/Puyo_Yellow.png",
